//nams3.c -- использование указателей и функции malloc ()
...
void getinfo (struct namect * pst)
{
    ...
    gets (temp);
    pst -> fname = (char *) malloc (strlen (temp) + 1);                         //распределение памяти для хранения имени
    strcpy (pst -> fname, temp);                                                //копирование имени в распределенную память

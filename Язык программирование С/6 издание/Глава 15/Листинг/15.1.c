/*ЬinЬit.c -- использование операций с битами для отображения двоичного представления чисел*/
...
{
    int i;
    static int size = СНАЯ_В1Т * sizeof (int);
...
/*отоброжение двоичной строки блоками по 4 элемента */ 

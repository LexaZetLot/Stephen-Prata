// usebrass2.cpp -- пример полиморыизма
//  омпилировать вместе с brass.срр 
#include <iostream>
#include <string>
#include "brass.h" 
const int CLIENTS = 4;
int main(void)
{
	...
	for (int i = 0; i < CLIENTS; i++)
	{
		...
		cout << "Enter 1 for Brass Account or "
			<< "2 for BrassPlus Account: "; // 1 Ч Brass Account; 2 Ч BrassPlus Account 
	...
	for (int i = 0; i < CLIENTS; i++)
	{
		delete p_clients[i];	// освобождение пам€ти 
	}
	cout << "Done.\n";
	return 0;
}
...
//удалите следующую строку, если _Static_assert из Cll не поддерживается 
...
int main (void)
{
    ...
    puts ("\nИспользование memmove () с перекрываю^щимися областями:");
    ...
    puts ("целевые данные -- 5 значений doUle в 10 позициях int:");
